...
import (
	...
	"github.com/industriousparadigm/go-graphql-api/gql"
	"github.com/industriousparadigm/go-graphql-api/postgres"
	"github.com/industriousparadigm/go-graphql-api/server"
)
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "diogo", "go_graphql_db"),
	)
	if err != nil {
		log.Fatal(err)
	}
